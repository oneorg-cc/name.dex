...
public class MethodsUtil {
    ...
    public static List<Method> filter(Object target, Predicate<Method> filter) {
        return filter(target, filter, false);
    }

    public static List<Method> filter(Object target, Predicate<Method> filter, boolean declared) {
        return filter(target.getClass(), filter, declared);
    }

    public static List<Method> filter(Class<?> target_class, Predicate<Method> filter) {
        return filter(target_class, filter, false);
    }

    public static List<Method> filter(Class<?> target_class, Predicate<Method> filter, boolean declared) {
