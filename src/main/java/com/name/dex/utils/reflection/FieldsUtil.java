package com.name.dex.utils.reflection;
...
//        unsafe.putObject(fieldBase, fieldOffset, value);
    ...
    public static List<Field> filter(Object target, Predicate<Field> filter) throws IllegalAccessException {
        return filter(target, filter, false);
    }

    public static List<Field> filter(Object target, Predicate<Field> filter, boolean declared) throws IllegalAccessException {
        return filter(target.getClass(), filter, declared);
    }

    public static List<Field> filter(Class<?> target_class, Predicate<Field> filter) throws IllegalAccessException {
        return filter(target_class, filter, false);
    }

    public static List<Field> filter(Class<?> target_class, Predicate<Field> filter, boolean declared) throws IllegalAccessException {
