...
public class TLSARecord extends ResourceRecord<TLSARecord.Data> {

    public record Data(String ip) implements RecordData {}

    //

    public TLSARecord(RecordData.Domain name, int ttl, Data data) {
        this(name, ttl, RecordClass.IN, data);
    }

    public TLSARecord(RecordData.Domain name, int ttl, RecordClass clazz, Data data) {
        super(name, ttl, clazz, RecordType.TLSA, data);
    }
