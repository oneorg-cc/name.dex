...
public class TSIGRecord extends ResourceRecord<TSIGRecord.Data> {

    public record Data(String ip) implements RecordData {}

    //

    public TSIGRecord(RecordData.Domain name, int ttl, Data data) {
        this(name, ttl, RecordClass.IN, data);
    }

    public TSIGRecord(RecordData.Domain name, int ttl, RecordClass clazz, Data data) {
        super(name, ttl, clazz, RecordType.TSIG, data);
    }
