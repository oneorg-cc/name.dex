...
public class KXRecord extends ResourceRecord<KXRecord.Data> {

    public record Data(String ip) implements RecordData {}

    //

    public KXRecord(RecordData.Domain name, int ttl, Data data) {
        this(name, ttl, RecordClass.IN, data);
    }

    public KXRecord(RecordData.Domain name, int ttl, RecordClass clazz, Data data) {
        super(name, ttl, clazz, RecordType.KX, data);
    }
